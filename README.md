...
This repository contains the Demo App OpenMRS Open Web App.
...
This will build and deploy the app to the `/Users/judywawira/Programming/Pascal/openmrs-standalone-1.11.0/appdata/owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "/Users/judywawira/Programming/Pascal/openmrs-standalone-1.11.0/appdata/owa"
}
```
...
{
  "LOCAL_OWA_FOLDER": "/Users/judywawira/Programming/Pascal/openmrs-standalone-1.11.0/appdata/owa",
  "APP_ENTRY_POINT": "http://localhost:8081/openmrs-standalone/owa/demoapp/index.html"
}
```
